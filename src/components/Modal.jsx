                ...
                <div className="relative">
                    <div className="flex h-screen photo">
                        <div style={{width: "600px", height: "600px"}} className="relative cursor-pointer rounded  shadow-lg bg-white m-auto">
                            <button onClick={closeModal} className="photo-close-btn absolute z-10 top-0 right-0 h-8 bg-gray-700 bg-white text-white font-semibold px-3 rounded-full rounded shadow">X</button>
                            <div className="w-full">
                                <img onClick={closeModal} style={{width: "600px", height: "600px"}} className="w-full" src={selectedPhoto} alt="Sunset in the mountains"/>
                            </div>
                        </div>
                    </div>
                </div>
